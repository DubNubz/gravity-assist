...
function changeColorStep (button: string) {
...
function characterLimit (num: number, type: "message" | "mail") {
  if (type == "message") {
    if (num >= 250) {
      return "black";
    } else if (num >= 175) {
...
function getButtonName (param1: string, param2: string, other: string | undefined) {
  if (other) {
    return String(other);
  }
